...
class Cowpea extends StatelessWidget {
  Cowpea({super.key});
  ...
  final List<Map<String, dynamic>> gridData = [
    ...
    {
      'image': 'assets/Details/BacterialBlight.jpg',
      'text1': 'Diseases',
      'text2': 'Bacterial Blight',
      'color': Colors.white,
    },
    {
      'image': 'assets/Details/Cowpea mosaic.jpg',
      'text1': 'Diseases ',
      'text2': 'Cowpea mosaic',
      'color': Colors.white,
    },
    ...
    {
      'image': 'assets/Details/SinSup.jpg',
      'text1': 'Fertilizers',
      'text2': 'SingleSuperPospate',
     'color': Colors.white,
    },
    {
      'image': 'assets/Details/pospho.jpg',
      'text1': 'Fertilizers',
      'text2': 'Phosphorus',
      'color': Colors.white,
    },
              ...
              child: Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    const SizedBox(width: 10),
                    Image.asset('assets/Details/Cowpee.png', width: 70, height: 70),
                  ],
                ),
              ),
            ),
