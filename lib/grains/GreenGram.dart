...
class GreenGram extends StatelessWidget {
  GreenGram({super.key});
  ...
  final List<Map<String, dynamic>> gridData = [
    ...
    {
      'image': 'assets/Details/rust.jpeg',
      'text1': 'Diseases',
      'text2': 'Rust',
      'color': Colors.white,
    },
    ...
    {
      'image': 'assets/Details/npk.jpg',
      'text1': 'Fertilizers',
      'text2': 'NPK',
      'color': Colors.white,
    },
    {
      'image': 'assets/Details/Rockpos.jpg',
      'text1': 'Fertilizers',
      'text2': 'Rockphospate ',
     'color': Colors.white,
    },
              ...
              child: Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    const SizedBox(width: 10),
                    Image.asset('assets/Details/greengram.png', width: 70, height: 70),
                  ],
                ),
              ),
            ),
