...
class Gchillie extends StatelessWidget {
  Gchillie({super.key});
  ...
  final List<Map<String, dynamic>> gridData = [
    ...
    {
      'image': 'assets/Details/fruitrot.jpeg',
      'text1': 'Diseases',
      'text2': 'Fruit rot',
      'color': Colors.white,
    },
    {
      'image': 'assets/Details/dampingoff.jpeg',
      'text1': 'Diseases ',
      'text2': 'Dampin off',
      'color': Colors.white,
    },
    ...
    },
    {
      ...
      'text1': 'Manure ',
      'text2': 'mature compost',
      'color': Colors.white,
    },
    {
      'image': 'assets/Details/rottedmanure.jpeg',
      'text1': 'Manure',
      'text2': 'well rotted manure',
     'color': Colors.white,
    },
  ];
@override
              ...
              child: Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    const SizedBox(width: 10),
                    Image.asset('assets/Details/gc.png', width: 70, height: 70),
                  ],
                ),
              ),
            ),
