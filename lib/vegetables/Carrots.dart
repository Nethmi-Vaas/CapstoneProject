...
class Carrot extends StatelessWidget {
  ...
  final List<Map<String, dynamic>> gridData = [
    ...
    {
      'image': 'assets/Details/v8.png',
      'text1': 'Diseases',
      'text2': 'Soft rot',
       'color': Colors.white,
    },
    {
      'image': 'assets/Details/v9.png',
      'text1': 'Diseases ',
      'text2': 'Blight',
       'color': Colors.white,
    },
              ...
              child: Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    const SizedBox(width: 10),
                    Image.asset('assets/Details/img_image_2.png', width: 70, height: 70),
                  ],
                ),
              ),
            ),
